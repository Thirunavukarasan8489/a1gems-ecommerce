        ...
        classNames={{
          control: ({ isFocused, isDisabled }) =>
            `flex items-center justify-between min-h-[42px] px-3 py-1 bg-white dark:bg-plum-950 border rounded-lg text-sm transition-colors ${
              isDisabled
                ? 'opacity-60 bg-ivory-100 dark:bg-plum-900 cursor-not-allowed'
                : 'cursor-pointer'
            } ${
              error
                ...
                : 'border-ivory-300 dark:border-plum-700 hover:border-ivory-400 dark:hover:border-plum-600'
            }`,
          ...
          menu: () => 'mt-1.5 bg-white dark:bg-plum-900 border border-ivory-300 dark:border-plum-800 rounded-lg shadow-lg overflow-hidden z-50 py-1',
          ...
          option: ({ isFocused, isSelected }) =>
            `px-3 py-2 cursor-pointer transition-colors text-sm ${
              isSelected
                ...
                : isFocused
                ? 'bg-ivory-100 dark:bg-plum-800 text-plum-900 dark:text-ivory-100'
          ...
          clearIndicator: () => 'p-1 text-plum-400 hover:text-red-500 cursor-pointer',
          indicatorSeparator: () => 'bg-ivory-300 dark:bg-plum-700 my-1 mx-1.5 w-px',
        }}
        {...props}
      />
