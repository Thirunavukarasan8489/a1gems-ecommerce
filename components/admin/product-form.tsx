  ...
  return (
    <form className="max-w-4xl">
      <FormSection title="Basic Information">
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input type="text" className="w-full border border-slate-300 rounded-md p-2" placeholder="e.g. Emerald Ring" />
          </div>
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-1">Slug</label>
            <input type="text" className="w-full border border-slate-300 rounded-md p-2" placeholder="emerald-ring" />
          </div>
        </div>
        <div>
          <label className="block text-sm font-medium text-slate-700 mb-1">Description</label>
          <textarea className="w-full border border-slate-300 rounded-md p-2 h-32" />
        </div>
      </FormSection>
      ...
      <FormSection title="Pricing & Inventory">
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input type="number" className="w-full border border-slate-300 rounded-md p-2" />
          </div>
          <div>
      ...
      <div className="flex justify-end space-x-4 mt-6">
        <button type="button" className="px-4 py-2 border border-slate-300 rounded-md text-slate-700 hover:bg-slate-50">Cancel</button>
        <button type="submit" className="px-4 py-2 bg-slate-900 text-white rounded-md hover:bg-slate-800">Save Product</button>
      </div>
    </form>
  );
}
